...
Unzip the archive. This will create a folder called xml-sample-demo-master with a subfolder EVOLUTION.
...
The install folder is a sub-folder of the EVOLUTION folder.
...
The results of the installation can be found in the EVOLUTION.log file.
...
The demonstration is installed using the EVOLUTION.sh script found in the folder xml-sample-demo-master/EVOLUTION/install.
...
Once the script has completed check the EVOLUTION.log file for any errors. If there are no errors in the log file verify that the installation completed successfully by opening a browser and navigating to the following URL http://hostname:port/XFILES. Login as the user specified during the installation procedure and click on the “Home” button [![](media/image012.png)].
...
<<<<<<< HEAD
If the demonstration was installed successfully, the home folder contains a folder called “demonstrations” which inturn contains a folder called “evolution”.
=======
If the demonstration was installed successfully, the home folder should contain a folder called "demonstrations" which inturn contains a folder called “evolution”.
>>>>>>> origin/master

Navigate to the “evolution” folder and click the index.html file. This should open a new browser tab or window, ready to run the first step of the example.
