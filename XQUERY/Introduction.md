...
The demonstration is installed using the XQUERY.sh script found in the folder xml-sample-demo/XQUERY/install.
...
If the demonstration was installed successfully, the home folder should contain a folder call demonstrations which will contain a folder called “XQuery”.
